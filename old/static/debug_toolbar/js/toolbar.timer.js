(function ($) {
  ...
  function addRow(stat, endStat) {
    rowCount++;
    var $row = $(
      '<tr class="' + (rowCount % 2 ? 'djDebugOdd' : 'djDebugEven') + '"></tr>'
    );
    if (endStat) {
      ...
      $row.html(
        '<td>' +
          stat.replace('Start', '') +
          '</td>' +
          '<td class="timeline"><div class="djDebugTimeline"><div class="djDebugLineChart" style="left:' +
          getLeft(stat) +
          '%;"><strong style="width:' +
      ...
      $row.html(
        '<td>' +
          ...
          '<td class="timeline"><div class="djDebugTimeline"><div class="djDebugLineChart" style="left:' +
          getLeft(stat) +
          '%;"><strong style="width:2px;">&nbsp;</strong></div></div></td>' +
          '<td>' +
          (perf.timing[stat] - timingOffset) +
          '</td>'
      );
