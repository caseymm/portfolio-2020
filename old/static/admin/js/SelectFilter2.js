  ...
  window.SelectFilter = {
    init: function (field_id, field_name, is_stacked, admin_static_prefix) {
      ...
      quickElement(
        ...
        '',
        'src',
        admin_static_prefix + 'img/icon-unknown.gif',
        'width',
        '10',
        'height',
        '10',
      ...
      var search_selector_img = quickElement(
        ...
        '',
        'src',
        admin_static_prefix + 'img/selector-search.gif',
        'class',
        'help-tooltip',
        'alt',
        '',
      ...
      var choose_all = quickElement(
        ...
        'href',
        'javascript: (function(){ SelectBox.move_all("' +
          field_id +
          '_from", "' +
          field_id +
          '_to"); SelectFilter.refresh_icons("' +
          field_id +
          '");})()',
        'id',
      ...
      var add_link = quickElement(
        ...
        gettext('Choose'),
        'href',
        'javascript: (function(){ SelectBox.move("' +
          field_id +
          '_from","' +
          field_id +
          '_to"); SelectFilter.refresh_icons("' +
      ...
      var remove_link = quickElement(
        ...
        'javascript: (function(){ SelectBox.move("' +
          ...
          '_to","' +
          field_id +
          '_from"); SelectFilter.refresh_icons("' +
          field_id +
          '");})()',
        'id',
