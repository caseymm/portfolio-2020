...
var DateTimeShortcuts = {
  ...
  addTimezoneWarning: function (inp) {
    ...
    if ($(inp).siblings('.' + warningClass).length) return;
  ...
  addClock: function (inp) {
    ...
    now_link.setAttribute(
      'href',
      'javascript:DateTimeShortcuts.handleClockQuicklink(' + num + ', -1);'
    );
    now_link.appendChild(document.createTextNode(gettext('Now')));
    var clock_link = document.createElement('a');
    clock_link.setAttribute(
      'href',
    ...
    quickElement(
      ...
      gettext('Midnight'),
      'href',
      'javascript:DateTimeShortcuts.handleClockQuicklink(' + num + ', 0);'
    );
    quickElement(
      'a',
      quickElement('li', time_list),
      gettext('6 a.m.'),
      'href',
      'javascript:DateTimeShortcuts.handleClockQuicklink(' + num + ', 6);'
    );
    quickElement(
      'a',
      quickElement('li', time_list),
      gettext('Noon'),
      'href',
      'javascript:DateTimeShortcuts.handleClockQuicklink(' + num + ', 12);'
    );
  ...
  addCalendar: function (inp) {
    ...
    today_link.setAttribute(
      'href',
      'javascript:DateTimeShortcuts.handleCalendarQuickLink(' + num + ', 0);'
    );
    today_link.appendChild(document.createTextNode(gettext('Today')));
    var cal_link = document.createElement('a');
    cal_link.setAttribute(
      'href',
    ...
    quickElement(
      ...
      '',
      'src',
      DateTimeShortcuts.admin_media_prefix + 'img/icon_calendar.gif',
      'alt',
      gettext('Calendar')
    );
    shortcuts_span.appendChild(document.createTextNode('\240'));
    ...
    var cal_nav_prev = quickElement(
      'a',
      cal_nav,
      '<',
      'href',
      'javascript:DateTimeShortcuts.drawPrev(' + num + ');'
    );
    cal_nav_prev.className = 'calendarnav-previous';
    var cal_nav_next = quickElement(
      'a',
      cal_nav,
      '>',
      'href',
    ...
    quickElement(
      ...
      gettext('Yesterday'),
      'href',
      'javascript:DateTimeShortcuts.handleCalendarQuickLink(' + num + ', -1);'
    );
  ...
  handleCalendarCallback: function (num) {
    ...
    format = format.replace("'", "\\'");
    return [
      'function(y, m, d) { DateTimeShortcuts.calendarInputs[',
      num,
